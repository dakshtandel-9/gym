...
const fitnessFacts = [
    {
        ...
        image: "/media/images/1.png", // Update to the correct image path
    },
    {
            ...
            <Grid container spacing={4}>
                {fitnessFacts.map((fact, index) => (
                    <Grid item xs={12} sm={6} md={4} key={index}>
                        <Card className="card-animation" sx={{ backgroundColor: '#1c1c1c', color: 'white' }}>
                            <img
                                src={fact.image}
                                alt={fact.title}
